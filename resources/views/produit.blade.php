	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="/produit" class="nav-link">Menu</a></li>
	    		...
	    		<div class="col-lg-8 ftco-animate p-md-5">
		          ...
		          <div class="col-md-12 nav-link-wrap mb-5">
		            <div class="nav ftco-animate nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
		              ...
		              <a class="nav-link" id="v-pills-3-tab" data-toggle="pill" href="#v-pills-3" role="tab" aria-controls="v-pills-3" aria-selected="false">Salad</a>

		              <a class="nav-link" id="v-pills-4-tab" data-toggle="pill" href="#v-pills-4" role="tab" aria-controls="v-pills-4" aria-selected="false">Dessert</a>
		            </div>
		          </div>
		            ...
		            <div class="tab-content ftco-animate" id="v-pills-tabContent">
		              ...
		              <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-1-tab">
		              	<div class="row">
                            ...
                            @if($item->category->nomCat === 'Pizza')
                                <div class="col-md-4 text-center">
                                    <div class="menu-wrap">
                                        <a href="#" class="menu-img img mb-4" style="background-image: url({{$item->imgPath}});"></a>
                                        <div class="text">
                                            <h3><a href="{{route('about_prod', ['id'=>$item->id])}}">{{$item->nom}}</a></h3>
                                            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
                                            <p class="price"><span>{{$item->prix}} MAD</span></p>
                                            <p><a href="{{route('addToCart' , ['id' => $item->id])}}" class="btn btn-white btn-outline-white">Add to cart</a></p>
                                        </div>
                                    </div>
                                </div>
                                @endif 
		              ...
		              <div class="tab-pane fade" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-2-tab">
		                <div class="row">
                        @foreach ($produits as $item)
                            @if($item->category->nomCat === 'boisson')
		              		<div class="col-md-4 text-center">
		              			<div class="menu-wrap">
		              				<a href="#" class="menu-img img mb-4" style="background-image: url({{$item->imgPath}});"></a>
		              				<div class="text">
		              ...
		              <div class="tab-pane fade" id="v-pills-4" role="tabpanel" aria-labelledby="v-pills-4-tab">
		                <div class="row">
                        @foreach ($produits as $item)
                        @if($item->category->nomCat === 'dessert')
		              		<div class="col-md-4 text-center">
		              			<div class="menu-wrap">
		              				<a href="#" class="menu-img img mb-4" style="background-image: url({{$item->imgPath}});"></a>
		              				<div class="text">
		              					<h3><a href="{{route('about_prod', ['id'=>$item->id])}}">{{$item->nom}}</a></h3>
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p class="price"><span>{{$item->prix}}$</span></p>
		              					<p><a href="{{route('addToCart' , ['id' => $item->id])}}" class="btn btn-white btn-outline-white">Add to cart</a></p>
		              				</div>
		              			</div>
		              		</div>
